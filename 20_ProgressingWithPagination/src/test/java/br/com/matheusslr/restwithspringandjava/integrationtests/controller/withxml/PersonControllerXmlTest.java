...
public class PersonControllerXmlTest extends AbstractIntegrationTest {
    ...
    @Test
    @Order(9)
    public void testHATEOS() throws IOException, JsonMappingException, JsonProcessingException {
        ...
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/persons/v1/698</href></links>"));
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/persons/v1/377</href></links>"));
        assertTrue(content.contains("<links><rel>self</rel><href>http://localhost:8888/api/persons/v1/189</href></links>"));

        assertTrue(content.contains("<rel>first</rel><href>http://localhost:8888/api/persons/v1?direction=asc&amp;page=0&amp;size=12&amp;sort=firstName,asc</href>"));
        assertTrue(content.contains("<rel>self</rel><href>http://localhost:8888/api/persons/v1?page=0&amp;size=12&amp;direction=asc</href>"));
        assertTrue(content.contains("<rel>next</rel><href>http://localhost:8888/api/persons/v1?direction=asc&amp;page=1&amp;size=12&amp;sort=firstName,asc</href>"));
        assertTrue(content.contains("<rel>last</rel><href>http://localhost:8888/api/persons/v1?direction=asc&amp;page=83&amp;size=12&amp;sort=firstName,asc</href>"));

        assertTrue(content.contains("<page><size>12</size><totalElements>1006</totalElements><totalPages>84</totalPages><number>0</number></page>"));
    }

...
import br.com.matheusslr.restwithspringandjava.integrationtests.vo.wrapper.WrapperPersonVO;
...
public class PersonControllerJsonTest extends AbstractIntegrationTest {
    ...
    @Test
    @Order(7)
    public void testFindByName() throws IOException, JsonMappingException, JsonProcessingException {
    ...
    public void testHATEOS() throws IOException, JsonMappingException, JsonProcessingException {
        ...
        assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost:8888/api/persons/v1/727\"}}}"));
        assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost:8888/api/persons/v1/377\"}}}"));
        assertTrue(content.contains("\"_links\":{\"self\":{\"href\":\"http://localhost:8888/api/persons/v1/189\"}}}"));

        assertTrue(content.contains("{\"first\":{\"href\":\"http://localhost:8888/api/persons/v1?direction=asc&page=0&size=12&sort=firstName,asc\"}"));
        assertTrue(content.contains("\"self\":{\"href\":\"http://localhost:8888/api/persons/v1?page=0&size=12&direction=asc\"}"));
        assertTrue(content.contains("\"next\":{\"href\":\"http://localhost:8888/api/persons/v1?direction=asc&page=1&size=12&sort=firstName,asc\"}"));
        assertTrue(content.contains("\"last\":{\"href\":\"http://localhost:8888/api/persons/v1?direction=asc&page=83&size=12&sort=firstName,asc\"}}"));

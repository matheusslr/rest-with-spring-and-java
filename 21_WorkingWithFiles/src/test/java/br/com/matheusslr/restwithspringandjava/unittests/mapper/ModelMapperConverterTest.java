package br.com.matheusslr.restwithspringandjava.unittests.mapper;
...
public class ModelMapperConverterTest {
    ...
    public void parseEntityListToVOListTest() {
        List<PersonVO> outputList = MMapper.parseListObjects(inputObject.mockEntityList(), PersonVO.class);
    ...
    public void parserVOListToEntityListTest() {
        List<Person> outputList = MMapper.parseListObjects(inputObject.mockVOList(), Person.class);

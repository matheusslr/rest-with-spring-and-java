...
public class BookControllerYamlTest extends AbstractIntegrationTest {
    ...
    public void testHATEOAS() throws IOException, JsonMappingException, JsonProcessingException {
        ...
        assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/books/v1/896\""));
        assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/books/v1/375\""));
        assertTrue(content.contains("rel: \"self\"    href: \"http://localhost:8888/api/books/v1/1009\""));

        assertTrue(content.contains("rel: \"first\"  href: \"http://localhost:8888/api/books/v1?direction=asc&page=0&size=12&sort=author,asc\""));
        assertTrue(content.contains("rel: \"self\"  href: \"http://localhost:8888/api/books/v1?page=0&size=12&direction=asc\""));
        assertTrue(content.contains("rel: \"next\"  href: \"http://localhost:8888/api/books/v1?direction=asc&page=1&size=12&sort=author,asc\""));
        assertTrue(content.contains("rel: \"last\"  href: \"http://localhost:8888/api/books/v1?direction=asc&page=84&size=12&sort=author,asc\""));
